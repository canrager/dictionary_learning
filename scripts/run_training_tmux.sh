...
# Script to run run_training.py in a detached tmux session

SESSION_NAME="run_training"
SCRIPT_PATH="/home/can/dictionary_learning/training_demo/run_training.py"
